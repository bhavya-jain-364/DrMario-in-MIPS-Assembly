...
# Example usage
image_path = "game over.png"  # Replace with the path to your PNG
output_width =  64 # Desired width
output_height = 32  # Desired height
x_offset = 0  # Starting X position in bitmap
y_offset = 16  # Starting Y position in bitmap
